...
func start_tab_icons():
	var tab_target :TabContainer = $VBoxContainer/down/Panel/TabContainer
	for i in tab_target.get_tab_count():
		tab_target.set_tab_icon(i,load(str("res://assets/icons/tab_icon",i,".png")))
		tab_target.set_tab_title(i,"")
